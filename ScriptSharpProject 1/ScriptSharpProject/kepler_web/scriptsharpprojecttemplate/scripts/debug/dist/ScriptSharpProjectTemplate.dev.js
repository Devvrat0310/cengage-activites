...
(function () {
  ...
  Kepler.ScriptSharpProjectTemplate.Class1 = function () {
    this.$4();
    this.$3();
  };
  ...
  Kepler.ScriptSharpProjectTemplate.Class1.prototype = {
    ...
    $1: function $1($p0) {
      $p0.target.appendChild(this._elmDiv);
    },
    $2: function $2($p0) {},
    $3: function $3() {
      this._elmDiv.addEventListener("dragstart", ss.Delegate.create(this, this.$2), false);

      this._box2.addEventListener("dragover", ss.Delegate.create(this, this.$0), false);

      this._box3.addEventListener("dragover", ss.Delegate.create(this, this.$0), false);

      this._box2.addEventListener("drop", ss.Delegate.create(this, this.$1), false);

      this._box3.addEventListener("drop", ss.Delegate.create(this, this.$1), false);
    },
    $4: function $4() {
